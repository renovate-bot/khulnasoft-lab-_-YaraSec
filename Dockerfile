...
WORKDIR /home/khulnasoft/src/YaraSec
COPY . .
...
COPY --from=builder /home/khulnasoft/src/YaraSec/YaraSec .
COPY --from=builder /home/khulnasoft/src/YaraSec/config.yaml .

RUN cd /usr/local/ \
    && tar -xzf yara.tar.gz
WORKDIR /home/khulnasoft/output

ENTRYPOINT ["/home/khulnasoft/usr/YaraSec", "-config-path", "/home/khulnasoft/usr/config.yaml", "-rules-path", "/home/khulnasoft/usr"]
CMD ["-h"]
